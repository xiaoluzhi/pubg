...
public final class DianZanRsp extends Message {
  ...
  public DianZanRsp(Integer result, ByteString err_msg) {
    this.result = result;
    this.err_msg = err_msg;
  }

  private DianZanRsp(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DianZanRsp)) return false;
    DianZanRsp o = (DianZanRsp) other;
  ...
  public static final class Builder extends Message.Builder<DianZanRsp> {
    ...
    public Builder(DianZanRsp message) {
      super(message);
    ...
    @Override
    public DianZanRsp build() {
      checkRequiredFields();
      return new DianZanRsp(this);
    }
  }
}
