...
public final class DianZanReq extends Message {
  ...
  public DianZanReq(ByteString userid, ByteString openid, ByteString vid, ByteString nick, Integer op, ByteString gameid, Integer game_level) {
    this.userid = userid;
    this.openid = openid;
    this.vid = vid;
    this.nick = nick;
  ...
  private DianZanReq(Builder builder) {
    this(builder.userid, builder.openid, builder.vid, builder.nick, builder.op, builder.gameid, builder.game_level);
    setBuilder(builder);
  }
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DianZanReq)) return false;
    DianZanReq o = (DianZanReq) other;
  ...
  public static final class Builder extends Message.Builder<DianZanReq> {
    ...
    public Builder(DianZanReq message) {
      super(message);
    ...
    @Override
    public DianZanReq build() {
      return new DianZanReq(this);
    }
  }
}
