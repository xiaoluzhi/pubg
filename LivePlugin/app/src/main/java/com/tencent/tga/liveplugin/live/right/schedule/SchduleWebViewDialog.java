...
public class SchduleWebViewDialog extends BaseDialog {

    private final static String TAG = "SchduleRankDialog";
    ...
    public SchduleWebViewDialog(Context context, String jump_url) {
        super(context, R.style.Dialog);
        this.jump_url = jump_url;
        setLayout(R.layout.dialog_schdulerank, null);
        getWindow().setBackgroundDrawable(DLPluginLayoutInflater.getInstance(mContext).getContext().getResources().getDrawable(R.drawable.root_bg));
    ...
    private void setListener() {
        mIvRankBack.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void doH5Handle(){
        mWvRank = new WebView(LiveConfig.mWebViewContext);
...
//        mWebView.setBackgroundColor(0xff0b1423);
        ...
        webSetting.setUserAgentString(webSetting.getUserAgentString() + " MSDK/" + WeGame.getInstance().getMSDKVersion());
    ...
    protected void onStop() {
        ...
        try {
            ...
            TLog.e(TAG,"onStop error : "+e.getMessage());
        }
    }
